...
export type ThemeControllerGroupItem = string | {
    value: string
    label: string
}


export type ThemeControllerRadioGroupProps =
...
export const ThemeControllerRadioGroup = forwardRef<HTMLDivElement, ThemeControllerRadioGroupProps>((
    {
        value,
        onChange,
        items,
