...
<Footer className="p-10 bg-base-200 text-base-content">
  ...
  <nav>
    ...
    <Form.Control label="Enter your email address">
      <Join>
        <Join.Item>
          <Input placeholder="username@site.com" />
        </Join.Item>
        <Join.Item>
...
```tsx live
<Footer center className="p-4 bg-base-200 text-base-content">
  <aside>
...
```tsx live
<Footer center className="p-10 bg-primary text-primary-content">
  <aside>
    <svg
      width="50"
      height="50"
...
```tsx live
<Footer center className="p-10 bg-base-200 text-base-content rounded">
