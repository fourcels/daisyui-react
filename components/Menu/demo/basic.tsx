import { Select, Form, Divider, MenuProps, Menu, Toggle, Tooltip, Button } from 'daisyui-react';
    ...
    return (
        <>
            ...
            <div className='flex justify-center'>
                <Menu className='bg-base-200 rounded-box' size={size} direction={direction} responsive={responsive}>
                    <Menu.Item>
                        <a>
